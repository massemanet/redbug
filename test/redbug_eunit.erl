...
t_0_test() ->
  ...
  {_,_} = redbug:start("lists:sort",[{print_file,Filename},{print_time_unit,millisecond},debug]),
...
t_02_test() ->
  ...
  {_,_} = redbug:start("lists:sort",[{print_file,Filename},{print_time_unit,microsecond},debug]),
  [1,2,3] = lists:sort([3,2,1]),
  timer:sleep(100),
  redbug:stop(),
  timer:sleep(100),
